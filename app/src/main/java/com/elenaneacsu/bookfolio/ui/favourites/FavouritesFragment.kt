...
class FavouritesFragment : QuotesAdapter.OnItemClickListener,
    BaseMvvmFragment<FavouritesViewModel, FragmentFavouritesBinding>(
...
//        val quote1 = Quote(
//            text = "Deschizi o ușă și apare alta, apoi încă una și încă una, până la ultima, care nici nu există măcar, și tot așa până te pomenești la prima, care nici nu există măcar, și mai dai o raită prin locuri vechi pentru că ceea ce credeai că te scosese și chiar te scosese devine capcană și te readuce tot acolo ca să înțelegi odată că ultimul tău adevăr e la fel de iluzoriu pe cât fusese primul și ca să nu uiți că te afli totdeauna pe muchie de cuțit.",
//            book = "Zenobia", author = "Gellu Naum", page = "page 177", date = "June 1, 2021"
//        )
//
//        val quote2 = Quote(
//            text = "On essaye de créer des liens, vous comprenez...\n" +
...
//            book = "Dans le café de la jeunesse perdue",
...
//
//        val quote3 = Quote(
//            text = "You know what's the trouble with you? You're an expatriate. One of the worst type. You've lost touch with the soil. You get precious. Fake European standards have ruined you. You drink yourself to death. You become obsessed by sex. You spend all your time talking, not working. You are an expatriate, see. You hang around cafés.\nIt sounds like a swell life.",
...
//
//        val quote4 = Quote(
//            text = "there is a place in the heart that\n" +
...
//            book = "Agonie si extaz", author = "Irving Stone", page = "page 343", date = "March 21, 2021"
//        )
//
//        val quote6 = Quote(
//            text = "In the state I was in, if someone had come and told me I could go home quietly, that they would leave me my life whole, it would have left me cold: several hours or several years of waiting is all the same when you have lost the illusion of being eternal.",
//            book = "The Wall", author = "Jean-Paul Sartre", page = "page 87", date = "January 20, 2021"
//        )
//
//        val quote7 = Quote(
//            "some men never\n" +
